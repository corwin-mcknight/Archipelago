...
// while user code runs; the trap entry reads the first two fields by fixed byte offset
// (kstack_top at 0, user_sp at 8), so they must stay first and in this order.
struct cpu_core {
