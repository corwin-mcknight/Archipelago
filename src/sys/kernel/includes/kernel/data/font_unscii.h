...
// unscii 8x8 bitmap font: http://viznut.fi/unscii/ by Viznut, Public Domain.
// One byte per glyph row, MSB = leftmost pixel. Glyphs are contiguous from
// U+0020 (space); index a codepoint c in [0x20, 0xFF] as c - 0x20.
